...
public class RemoveAllDuplicateOccurancesOFNitishExceptFirst {
	static List<String> getNitishWithotDublicate(List<String> ListOfNames, String name) {
		/*
		 * List <String> withoutDublicate = new ArrayList <String>(); not require as it
		 * make changes in current list
		 */ while (ListOfNames.indexOf(name) != ListOfNames.lastIndexOf(name)) {
			ListOfNames.remove(ListOfNames.lastIndexOf(name)); // this keep firt occurance and remove the other
																// occurance
	...
	public static void main(String[] args) {
		...
		List<String> output = RemoveAllDuplicateOccurancesOFNitishExceptFirst.getNitishWithotDublicate(al,
				NameToRemove);
...
/*
 * Assignment - 77 : 11th Jan Remove all duplicate occurances of given name from
 * arrayList except first occurance.
 * 
