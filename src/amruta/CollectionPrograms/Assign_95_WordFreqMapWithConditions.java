...
public class Assign_95_WordFreqMapWithConditions {

	Map<String, Integer> getWordsWithFreqMoreThan1(String input) {
	...
	public static void main(String[] args) {
		...
		Map<String, Integer> wordsWithFreqMoreThan1 = new Assign_95_WordFreqMapWithConditions()
