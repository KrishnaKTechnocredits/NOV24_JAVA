...
public class A100_WordFreqUsingScannerAndMap {

	private static Map<String, Integer> getWordFreq(String str) {
	...
	public static void main(String[] args) {
		...
		scanner.close();
		Map<String, Integer> wordFreq = A100_WordFreqUsingScannerAndMap.getWordFreq(inputString);
