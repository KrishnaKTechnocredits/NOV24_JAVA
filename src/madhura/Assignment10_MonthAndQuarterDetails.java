...
public class Assignment10_MonthAndQuarterDetails {
		...
		void monthindex (int mindex){
			...
			public static void main (String [] args){
				Assignment10_MonthAndQuarterDetails mqdetails = new Assignment10_MonthAndQuarterDetails();
				mqdetails.monthindex(5);
				mqdetails.monthindex(2);
				mqdetails.monthindex(-3);
				mqdetails.monthindex(13);
			}
}
