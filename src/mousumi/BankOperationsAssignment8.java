...
public class BankOperationsAssignment8 {
	int balance;
	...
	void debitAmount(int debitAmount) {
		if (debitAmount > balance) {
			...
			balance -= debitAmount;
			System.out.println("Rs." + debitAmount + " has been debited from your account. Available balance is Rs." + balance);
		}
	}

	void creditAmount(int creditAmount) {
		balance += creditAmount;
		System.out.println("Rs." + creditAmount + " has been credited to your account. Available balance is Rs." + balance);
	}
	...
	public static void main(String[] args) {
		BankOperationsAssignment8 bankOperationAss8 = new BankOperationsAssignment8();
		bankOperationAss8.initBalance(5000);
		bankOperationAss8.creditAmount(2000);
		bankOperationAss8.debitAmount(9500);
		bankOperationAss8.debitAmount(6500);
		bankOperationAss8.creditAmount(1500);
		bankOperationAss8.displayBalance();
	}
 }
