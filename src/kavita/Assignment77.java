...
public class Assignment77 {
	List<String> removeDuplicateNamesExceptFirst(String name,List<String> arrayList){
	...
	public static void main(String[] args){
		...
		System.out.println("Output : " + assignment77.removeDuplicateNamesExceptFirst("Nitesh",arrayList));
	}
}
