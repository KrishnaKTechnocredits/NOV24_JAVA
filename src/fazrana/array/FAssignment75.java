...
public class FAssignment75 {
	...
	public static void main(String[] args) {
		...
		FAssignment75 fassignment75 = new FAssignment75();
		System.out.println("Prime Number array: " + Arrays.toString(fassignment75.getPrimeArray(input)));
	}
}
